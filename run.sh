...
if [ "$QUIET" = false ]; then
  echo "╔══════════════════════════════════════════════╗"
  echo "║  Infinite Loop Daemon v14.4.0                ║"
  echo "║  run.sh — one command to start               ║"
  echo "║                                                ║"
  echo "║  What's new ⚡                                ║"
  echo "║  • Readable startup banner: config overview   ║"
  echo "║  • Iteration header shows goal + progress bar ║"
  echo "║  • [DONE] line shows duration + classification║"
  echo "╚══════════════════════════════════════════════╝"
  echo ""
  echo "  Config: .env"
