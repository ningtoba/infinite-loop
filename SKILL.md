...
| `--self-test` | `false` | Run in-process self-tests (~40 tests across 8 daemon functions) and exit without spawning any sessions. Tests JSON parsing, error classification, text similarity, convergence detection, schema validation, adaptive cooldown, GoalSpec parsing, and progress classification. |
