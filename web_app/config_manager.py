...
CONFIG_DEFAULTS: dict[str, dict[str, Any]] = {
    "INFINITE_LOOP_GOAL": {
        ...
        "group": "core",
        "label": "Goal",
        "description": "Core task description for spawned pi sessions",
        "required": True,
        "multiline": True,
    },
    ...
    "INFINITE_LOOP_MAX_TURNS": {
        ...
        "group": "iteration",
        "label": "Max Turns",
        "description": "Max turns per spawned pi session",
    },
    ...
    "INFINITE_LOOP_WORKERS": {
        ...
        "group": "parallelism",
        "label": "Workers",
        "description": "Number of concurrent pi sessions per iteration",
    },
    ...
    "INFINITE_LOOP_ARCHIVE_DIR": {
        "default": "~/.config/pi-loop/infinite-loop-archives",
        "type": "string",
        "group": "archiving",
        "label": "Archive Dir",
    ...
    "INFINITE_LOOP_IGNORE_USER_CONFIG": {
        ...
        "description": "Skip ~/.config/pi-loop/config.yaml",
    },
...
def validate_config(config: dict[str, str]) -> dict[str, bool | list[str]]:
    """Validate configuration values. Returns {"valid": bool, "errors": [str]}."""
    errors: list[str] = []
